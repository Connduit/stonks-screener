...
all_asset_tickers = [asset.symbol for asset in all_assets if asset.exchange == AssetExchange.NASDAQ or asset.exchange == AssetExchange.NYSE or asset.exchange == AssetExchange.AMEX]
#print(all_assets)
